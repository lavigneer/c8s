...
// Package main implements the C8S Kubernetes controller for managing PipelineRuns.
package main
...
func init() {
	...
	utilruntime.Must(c8sv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	flag.StringVar(&leaderElectionID, "leader-election-id", "c8s-controller-leader",
